...
function RegistrarDadosProf(){
    ...
    var trm = document.getElementById("trma").options[trma.selectedIndex].textContent;
    
    document.getElementById("div").innerHTML = ( cd_id + "<br>" + nm + "<br>" + mtrc + "<br>" + trm);
}
...
function RegistrarDadosAlun(){
    ...
    var nm = document.getElementById("nm").value;
    var mtrc = document.getElementById("mtrc").value;
    var cr = document.getElementById("cor").options[cor.selectedIndex].textContent;
    
    var color = document.getElementById("cor").options[cor.selectedIndex].value;
    document.body.style.backgroundColor = color;
    
    document.getElementById("div").innerHTML = ( cd_id + "<br>" + nm + "<br>" + mtrc + "<br>" + cr);
}
